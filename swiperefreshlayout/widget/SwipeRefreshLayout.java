...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((i + ((int) (((float) (abs - i)) * f))) - swipeRefreshLayout2.e.getTop());
    ...
    private void moveSpinner(float f2) {
        ...
        int i3 = this.h + ((int) ((f3 * min) + (f3 * f4 * DECELERATE_INTERPOLATION_FACTOR)));
        ...
        this.k.setProgressRotation((((max * 0.4f) - 16.0f) + (f4 * DECELERATE_INTERPOLATION_FACTOR)) * DRAG_RATE);

...
class CircleImageView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        private void updateRadialGradient(int i) {
            float f = (float) (i / 2);
            this.mRadialGradient = new RadialGradient(f, f, (float) CircleImageView.this.a, new int[]{CircleImageView.FILL_SHADOW_COLOR, 0}, (float[]) null, Shader.TileMode.CLAMP);
    ...
    CircleImageView(Context context, int i) {
        ...
        if (elevationSupported()) {
            ...
            shapeDrawable2.getPaint().setShadowLayer((float) this.a, (float) i3, (float) i2, KEY_SHADOW_COLOR);
            int i4 = this.a;
